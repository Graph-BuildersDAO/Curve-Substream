    ...
    pub mod functions {
        ...
        pub struct BatchSetPoolAssetType {
            pub u_pools: [Vec<u8>; 32usize],
            pub u_asset_types: [substreams::scalar::BigInt; 32usize],
        }
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_coin),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct LiquidityGaugeDeployed1 {
            pub pool: Vec<u8>,
            pub token: Vec<u8>,
            pub gauge: Vec<u8>,
        }
        impl LiquidityGaugeDeployed1 {
            const TOPIC_ID: [u8; 32] = [
                29u8,
                98u8,
                71u8,
        ...
        impl substreams_ethereum::Event for LiquidityGaugeDeployed1 {
            const NAME: &'static str = "LiquidityGaugeDeployed1";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct LiquidityGaugeDeployed2 {
            pub pool: Vec<u8>,
            pub gauge: Vec<u8>,
        }
        impl LiquidityGaugeDeployed2 {
            const TOPIC_ID: [u8; 32] = [
                101u8,
                107u8,
                179u8,
        ...
        impl substreams_ethereum::Event for LiquidityGaugeDeployed2 {
            const NAME: &'static str = "LiquidityGaugeDeployed2";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for PoolAdded1 {
            const NAME: &'static str = "PoolAdded1";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for PoolAdded2 {
            const NAME: &'static str = "PoolAdded2";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
