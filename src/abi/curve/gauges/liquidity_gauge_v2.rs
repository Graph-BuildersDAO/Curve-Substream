    ...
    pub mod functions {
        ...
        impl ApprovedToDeposit {
            const METHOD_ID: [u8; 4] = [225u8, 82u8, 37u8, 54u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ApprovedToDeposit {
            const NAME: &'static str = "approved_to_deposit";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for ApprovedToDeposit {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ClaimHistoricRewards1 {
            pub u_reward_tokens: [Vec<u8>; 8usize],
        }
        impl ClaimHistoricRewards1 {
            const METHOD_ID: [u8; 4] = [185u8, 250u8, 122u8, 105u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ClaimHistoricRewards1 {
            const NAME: &'static str = "claim_historic_rewards1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ClaimHistoricRewards2 {
            pub u_reward_tokens: [Vec<u8>; 8usize],
            pub u_addr: Vec<u8>,
        }
        impl ClaimHistoricRewards2 {
            const METHOD_ID: [u8; 4] = [122u8, 34u8, 239u8, 103u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ClaimHistoricRewards2 {
            const NAME: &'static str = "claim_historic_rewards2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct CrvToken {}
        impl CrvToken {
            const METHOD_ID: [u8; 4] = [118u8, 216u8, 177u8, 23u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for CrvToken {
            const NAME: &'static str = "crv_token";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CrvToken {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl RewardContract {
            const METHOD_ID: [u8; 4] = [191u8, 136u8, 166u8, 255u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for RewardContract {
            const NAME: &'static str = "reward_contract";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for RewardContract {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl RewardIntegral {
            const METHOD_ID: [u8; 4] = [115u8, 134u8, 31u8, 179u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for RewardIntegral {
            const NAME: &'static str = "reward_integral";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetApproveDeposit {
            pub addr: Vec<u8>,
            pub can_deposit: bool,
        }
        impl SetApproveDeposit {
            const METHOD_ID: [u8; 4] = [29u8, 39u8, 71u8, 212u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(ethabi::Address::from_slice(&self.addr)),
                        ethabi::Token::Bool(self.can_deposit.clone()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
        ...
        impl substreams_ethereum::Function for SetApproveDeposit {
            const NAME: &'static str = "set_approve_deposit";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct SetRewards {
            pub u_reward_contract: Vec<u8>,
            pub u_sigs: [u8; 32usize],
            pub u_reward_tokens: [Vec<u8>; 8usize],
        }
        impl SetRewards {
            const METHOD_ID: [u8; 4] = [71u8, 210u8, 213u8, 211u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_reward_contract),
                        ),
                        ethabi::Token::FixedBytes(self.u_sigs.as_ref().to_vec()),
                        {
                            let v = self
                                .u_reward_tokens
                                .iter()
        ...
        impl substreams_ethereum::Function for SetRewards {
            const NAME: &'static str = "set_rewards";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
