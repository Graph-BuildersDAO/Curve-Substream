...
pub mod functions {
    ...
    impl ClaimableReward {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.u_user)),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_reward_token),
                    ),
                ],
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DepositRewardToken {
        pub u_reward_token: Vec<u8>,
        pub u_amount: substreams::scalar::BigInt,
    }
    impl DepositRewardToken {
    ...
    impl substreams_ethereum::Function for DepositRewardToken {
        const NAME: &'static str = "deposit_reward_token";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
