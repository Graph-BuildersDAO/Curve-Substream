...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ClaimableRewardWrite {
        pub u_addr: Vec<u8>,
        pub u_token: Vec<u8>,
    }
    impl ClaimableRewardWrite {
        const METHOD_ID: [u8; 4] = [89u8, 183u8, 228u8, 9u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ClaimableRewardWrite {
        const NAME: &'static str = "claimable_reward_write";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl LastClaim {
        const METHOD_ID: [u8; 4] = [52u8, 136u8, 189u8, 25u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for LastClaim {
        const NAME: &'static str = "last_claim";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Period {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl SetKilled {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Bool(self.u_is_killed.clone())]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
