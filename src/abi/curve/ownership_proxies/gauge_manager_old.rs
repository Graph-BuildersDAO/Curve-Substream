...
pub mod functions {
    ...
    impl OwnerProxy {
        const METHOD_ID: [u8; 4] = [203u8, 2u8, 62u8, 109u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for OwnerProxy {
        const NAME: &'static str = "owner_proxy";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for OwnerProxy {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl SetGaugeManager {
        ...
        pub fn decode(
            ...
            Ok(Self {
                u_gauge: ethabi::decode(
                        &[ethabi::ParamType::Address],
                        log.topics[1usize].as_ref(),
                    )
                    .map_err(|e| {
                        format!(
                            "unable to decode param 'u_gauge' from topic of type 'address': {:?}",
                            e
                        )
                    })?
                    .pop()
                    ...
                    .as_bytes()
                    .to_vec(),
                u_gauge_manager: ethabi::decode(
                        &[ethabi::ParamType::Address],
                        log.topics[2usize].as_ref(),
                    )
                    .map_err(|e| {
                        format!(
                            "unable to decode param 'u_gauge_manager' from topic of type 'address': {:?}",
                            e
                        )
                    })?
                    .pop()
    ...
    impl SetManager {
        ...
        pub fn decode(
            ...
            Ok(Self {
                u_manager: ethabi::decode(
                        &[ethabi::ParamType::Address],
                        log.topics[1usize].as_ref(),
                    )
                    .map_err(|e| {
                        format!(
                            "unable to decode param 'u_manager' from topic of type 'address': {:?}",
                            e
                        )
                    })?
                    .pop()
    ...
    impl substreams_ethereum::Event for SetManager {
        const NAME: &'static str = "SetManager";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
