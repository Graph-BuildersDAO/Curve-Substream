    ...
    pub mod functions {
        ...
        pub struct SetTokenImplementation {
            pub u_token_implementation: Vec<u8>,
        }
        impl SetTokenImplementation {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_token_implementation),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    pub mod events {
        ...
        pub struct UpdateTokenImplementation {
            pub u_old_token_implementation: Vec<u8>,
            pub u_new_token_implementation: Vec<u8>,
        }
        impl UpdateTokenImplementation {
            ...
            pub fn decode(
                ...
                values.reverse();
                Ok(Self {
                    u_old_token_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
                        .as_bytes()
                        .to_vec(),
                    u_new_token_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
