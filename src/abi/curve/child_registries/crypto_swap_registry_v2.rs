...
pub mod functions {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.u_zap)),
                    ethabi::Token::Uint(
    ...
    pub struct AddPool3 {
        ...
        pub u_name: String,
        pub u_base_pool: Vec<u8>,
        pub u_has_positive_rebasing_tokens: bool,
    }
    impl AddPool3 {
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                u_base_pool: values
                    ...
                    .as_bytes()
                    .to_vec(),
                u_has_positive_rebasing_tokens: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bool()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.u_has_positive_rebasing_tokens.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetD {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
