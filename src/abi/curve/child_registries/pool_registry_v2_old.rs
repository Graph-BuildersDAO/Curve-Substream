...
pub mod functions {
    ...
    pub struct AddMetapool {
        pub u_pool: Vec<u8>,
        pub u_n_coins: substreams::scalar::BigInt,
        pub u_lp_token: Vec<u8>,
        pub u_decimals: substreams::scalar::BigInt,
    }
    impl AddMetapool {
        const METHOD_ID: [u8; 4] = [207u8, 237u8, 173u8, 60u8];
        pub fn decode(
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_decimals.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for AddMetapool {
        const NAME: &'static str = "add_metapool";
    ...
    pub struct AddPool {
        ...
        pub u_n_coins: substreams::scalar::BigInt,
        pub u_lp_token: Vec<u8>,
        pub u_rate_method_id: [u8; 32usize],
        pub u_decimals: substreams::scalar::BigInt,
        pub u_underlying_decimals: substreams::scalar::BigInt,
        pub u_has_initial_a: bool,
        pub u_is_v1: bool,
    }
    impl AddPool {
        const METHOD_ID: [u8; 4] = [41u8, 11u8, 30u8, 72u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::FixedBytes(self.u_rate_method_id.as_ref().to_vec()),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_decimals.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_underlying_decimals.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Bool(self.u_has_initial_a.clone()),
                    ethabi::Token::Bool(self.u_is_v1.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    pub struct AddPoolWithoutUnderlying {
        ...
        pub u_rate_method_id: [u8; 32usize],
        pub u_decimals: substreams::scalar::BigInt,
        pub u_use_rates: substreams::scalar::BigInt,
        pub u_has_initial_a: bool,
        pub u_is_v1: bool,
    }
    impl AddPoolWithoutUnderlying {
        const METHOD_ID: [u8; 4] = [96u8, 192u8, 111u8, 137u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_use_rates.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    pub struct SetCoinGasEstimates {
        pub u_addr: [Vec<u8>; 10usize],
        pub u_amount: [substreams::scalar::BigInt; 10usize],
    }
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.u_pool)),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_estimator),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    pub struct SetLiquidityGauges {
        pub u_pool: Vec<u8>,
        pub u_liquidity_gauges: [Vec<u8>; 10usize],
    }
    ...
    pub struct SetPoolGasEstimates {
        pub u_addr: [Vec<u8>; 5usize],
        pub u_amount: [[substreams::scalar::BigInt; 2usize]; 5usize],
    }
