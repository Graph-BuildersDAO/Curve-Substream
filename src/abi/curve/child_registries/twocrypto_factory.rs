    ...
    pub mod functions {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_admin),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        pub struct SetMathImplementation {
            pub u_math_implementation: Vec<u8>,
        }
        impl SetMathImplementation {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_math_implementation),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        pub struct SetPoolImplementation {
            pub u_pool_implementation: Vec<u8>,
            pub u_implementation_index: substreams::scalar::BigInt,
        }
        impl SetPoolImplementation {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_pool_implementation),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_implementation_index.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        pub struct SetViewsImplementation {
            pub u_views_implementation: Vec<u8>,
        }
        impl SetViewsImplementation {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_views_implementation),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    pub mod events {
        ...
        pub struct UpdateFeeReceiver {
            pub u_old_fee_receiver: Vec<u8>,
            pub u_new_fee_receiver: Vec<u8>,
        }
        ...
        pub struct UpdateGaugeImplementation {
            pub u_old_gauge_implementation: Vec<u8>,
            pub u_new_gauge_implementation: Vec<u8>,
        }
        impl UpdateGaugeImplementation {
            ...
            pub fn decode(
                ...
                values.reverse();
                Ok(Self {
                    u_old_gauge_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
                        .as_bytes()
                        .to_vec(),
                    u_new_gauge_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
        ...
        pub struct UpdateMathImplementation {
            pub u_old_math_implementation: Vec<u8>,
            pub u_new_math_implementation: Vec<u8>,
        }
        impl UpdateMathImplementation {
            ...
            pub fn decode(
                ...
                values.reverse();
                Ok(Self {
                    u_old_math_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
                        .as_bytes()
                        .to_vec(),
                    u_new_math_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
        ...
        pub struct UpdatePoolImplementation {
            pub u_implemention_id: substreams::scalar::BigInt,
            pub u_old_pool_implementation: Vec<u8>,
            pub u_new_pool_implementation: Vec<u8>,
        }
        impl UpdatePoolImplementation {
            ...
            pub fn decode(
                ...
                Ok(Self {
                    ...
                    u_old_pool_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
                        .as_bytes()
                        .to_vec(),
                    u_new_pool_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
        ...
        pub struct UpdateViewsImplementation {
            pub u_old_views_implementation: Vec<u8>,
            pub u_new_views_implementation: Vec<u8>,
        }
        impl UpdateViewsImplementation {
            ...
            pub fn decode(
                ...
                values.reverse();
                Ok(Self {
                    u_old_views_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
                        .as_bytes()
                        .to_vec(),
                    u_new_views_implementation: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_address()
                        .expect(INTERNAL_ERR)
