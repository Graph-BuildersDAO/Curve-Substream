...
pub mod functions {
    ...
    pub struct AddLiquidity {
        pub u_amounts: [substreams::scalar::BigInt; 2usize],
        pub u_min_mint_amount: substreams::scalar::BigInt,
    }
    impl AddLiquidity {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_min_mint_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BaseCacheUpdated {}
    impl BaseCacheUpdated {
        const METHOD_ID: [u8; 4] = [130u8, 150u8, 248u8, 79u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for BaseCacheUpdated {
        const NAME: &'static str = "base_cache_updated";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for BaseCacheUpdated {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct BaseCoins {
        pub arg0: substreams::scalar::BigInt,
    }
    impl BaseCoins {
        const METHOD_ID: [u8; 4] = [135u8, 203u8, 79u8, 87u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for BaseCoins {
        const NAME: &'static str = "base_coins";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for BaseCoins {
    ...
    pub struct BasePool {}
    impl BasePool {
        const METHOD_ID: [u8; 4] = [93u8, 99u8, 98u8, 187u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for BasePool {
        const NAME: &'static str = "base_pool";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for BasePool {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl BaseVirtualPrice {
        const METHOD_ID: [u8; 4] = [149u8, 204u8, 192u8, 47u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for BaseVirtualPrice {
        const NAME: &'static str = "base_virtual_price";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.u_is_deposit.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    pub struct Exchange {
        ...
        pub u_dx: substreams::scalar::BigInt,
        pub u_min_dy: substreams::scalar::BigInt,
    }
    impl Exchange {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_dx.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_min_dy.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    pub struct RemoveLiquidity {
        ...
        pub u_min_amounts: [substreams::scalar::BigInt; 2usize],
    }
    ...
    pub struct RemoveLiquidityImbalance {
        pub u_amounts: [substreams::scalar::BigInt; 2usize],
        pub u_max_burn_amount: substreams::scalar::BigInt,
    }
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_max_burn_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    pub struct RemoveLiquidityOneCoin {
        pub u_token_amount: substreams::scalar::BigInt,
        pub i: substreams::scalar::BigInt,
        pub u_min_amount: substreams::scalar::BigInt,
    }
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_min_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
