    ...
    pub mod functions {
        ...
        pub struct AddLiquidity1 {
            pub u_amounts: [substreams::scalar::BigInt; 3usize],
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Bool(self.u_use_underlying.clone()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
        ...
        impl CommitNewFee {
            const METHOD_ID: [u8; 4] = [7u8, 70u8, 221u8, 90u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct FutureOffpegFeeMultiplier {}
        impl FutureOffpegFeeMultiplier {
            const METHOD_ID: [u8; 4] = [30u8, 76u8, 78u8, 248u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for FutureOffpegFeeMultiplier {
            const NAME: &'static str = "future_offpeg_fee_multiplier";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct RemoveLiquidity1 {
            ...
            pub u_min_amounts: [substreams::scalar::BigInt; 3usize],
        }
        ...
        impl RemoveLiquidityImbalance2 {
            const METHOD_ID: [u8; 4] = [91u8, 131u8, 105u8, 245u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl RemoveLiquidityOneCoin2 {
            const METHOD_ID: [u8; 4] = [81u8, 122u8, 85u8, 163u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetAaveReferral {
            pub referral_code: substreams::scalar::BigInt,
        }
        impl SetAaveReferral {
            const METHOD_ID: [u8; 4] = [182u8, 170u8, 100u8, 197u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetAaveReferral {
            const NAME: &'static str = "set_aave_referral";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UnderlyingCoins1 {
            pub arg0: substreams::scalar::BigInt,
        }
        impl UnderlyingCoins1 {
            const METHOD_ID: [u8; 4] = [185u8, 148u8, 126u8, 176u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for UnderlyingCoins1 {
            const NAME: &'static str = "underlying_coins1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for UnderlyingCoins1 {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl substreams_ethereum::Function for UnderlyingCoins2 {
            const NAME: &'static str = "underlying_coins2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for UnderlyingCoins2 {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
