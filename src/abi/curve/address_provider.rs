...
pub mod functions {
    ...
    pub struct AddNewId {
        pub u_address: Vec<u8>,
        pub u_description: String,
    }
    impl AddNewId {
        const METHOD_ID: [u8; 4] = [22u8, 143u8, 149u8, 121u8];
        pub fn decode(
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.u_address)),
                    ethabi::Token::String(self.u_description.clone()),
                ],
            );
    ...
    impl substreams_ethereum::Function for AddNewId {
        const NAME: &'static str = "add_new_id";
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for ApplyTransferOwnership {
    ...
    impl CommitTransferOwnership {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Address(ethabi::Address::from_slice(&self.u_new_admin))],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for CommitTransferOwnership {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl GetAddress {
        const METHOD_ID: [u8; 4] = [73u8, 63u8, 79u8, 116u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetAddress {
        const NAME: &'static str = "get_address";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetIdInfo {
        pub arg0: substreams::scalar::BigInt,
    }
    impl GetIdInfo {
        const METHOD_ID: [u8; 4] = [146u8, 102u8, 142u8, 203u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetIdInfo {
        const NAME: &'static str = "get_id_info";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<
        (Vec<u8>, bool, substreams::scalar::BigInt, substreams::scalar::BigInt, String),
    > for GetIdInfo {
        fn output(
            data: &[u8],
        ) -> Result<
    ...
    impl GetRegistry {
        const METHOD_ID: [u8; 4] = [162u8, 98u8, 144u8, 75u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    pub struct MaxId {}
    impl MaxId {
        const METHOD_ID: [u8; 4] = [12u8, 109u8, 120u8, 79u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for RevertTransferOwnership {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl SetAddress {
        const METHOD_ID: [u8; 4] = [106u8, 132u8, 202u8, 208u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetAddress {
        const NAME: &'static str = "set_address";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for SetAddress {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl UnsetAddress {
        const METHOD_ID: [u8; 4] = [94u8, 236u8, 13u8, 170u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for UnsetAddress {
        const NAME: &'static str = "unset_address";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for UnsetAddress {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl substreams_ethereum::Event for AddressModified {
        const NAME: &'static str = "AddressModified";
    ...
    impl substreams_ethereum::Event for NewAddressIdentifier {
        const NAME: &'static str = "NewAddressIdentifier";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
